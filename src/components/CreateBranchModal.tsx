  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" style={{ maxWidth: 440 }} onClick={e => e.stopPropagation()}>
        <div className="modal-icon"><SvgBranch /></div>
        <h3 className="modal-title">Crear Rama</h3>
        <p className="modal-desc">Elige el tipo y nombre de la nueva rama:</p>
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div className="modal-actions" style={{ marginTop: 2 }}>
            ...
            <button type="submit" className="btn-primary" disabled={creating || !branchName.trim()}>
              {creating ? <span className="spinner-sm" /> : <SvgBranch />} Crear
            </button>
          </div>
        </form>
      </div>
